...
%\newcommand{\ormat}[1]{\boldsymbol{\mathscr{\MakeUppercase\overrightarrow{{#1}}}}} %oriented matrix
\newcommand{\ormat}[1]{\overrightarrow{\mathcal{#1}}} %oriented matrix
\newcommand{\tube}[1]{\overrightarrow{\bold{#1}}} %tube
